...
class MyModalBody extends Component{
  ...
  saveNote = (event)=>{
    ...
    axios
      .put("http://127.0.0.1:8000/api/note/" + noteId, data,config)
      .then(
        (res) => {
          console.log(res);
          this.props.onHide()
  ...
  <Form.Group controlId="formBasicEmail">
    ...
    <Form.Control type="text" onChange={this.handleTitleChange} value={this.state.noteTitle} />
  </Form.Group>

  <Form.Group controlId="formBasicEmail">
    <Form.Label>Body</Form.Label>
    <Form.Control type="text" onChange={this.handleBodyChange} value={this.state.noteBody} />
  </Form.Group>
  <Modal.Footer>
